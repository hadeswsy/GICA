...
(function(jQuery_1_4_2) {
    ...
    jQuery_1_4_2.fn.colorpicker = function(options) {
        var opts = jQuery_1_4_2.extend({}, jQuery_1_4_2.fn.colorpicker.defaults, options);
        initColor();
        return this.each(function(){
            var obj = jQuery_1_4_2(this);
            obj.bind(opts.event,function(){
                //定位
                var ttop  = jQuery_1_4_2(this).offset().top;     //控件的定位点高
                var thei  = jQuery_1_4_2(this).height();  //控件本身的高
                var tleft = jQuery_1_4_2(this).offset().left;    //控件的定位点宽
                jQuery_1_4_2("#colorpanel").css({
                    top:ttop+thei+5,
                    left:tleft
                }).show();
                var target = opts.target ? jQuery_1_4_2(opts.target) : obj;
                ...
                jQuery_1_4_2("#_creset").bind("click",function(){
                    target.css("color", target.data("color")).val(target.data("value"));
                    jQuery_1_4_2("#colorpanel").hide();
                    opts.reset(obj);
                });
          
                jQuery_1_4_2("#CT tr td").unbind("click").mouseover(function(){
                    var color=jQuery_1_4_2(this).css("background-color");
                    jQuery_1_4_2("#DisColor").css("background",color);
                    jQuery_1_4_2("#HexColor").val(jQuery_1_4_2(this).attr("rel"));
                }).click(function(){
                    var color=jQuery_1_4_2(this).attr("rel");
                    color = opts.ishex ? color : getRGBColor(color);
                    if(opts.fillcolor) target.val(color);
                    target.css("color",color);
                    jQuery_1_4_2("#colorpanel").hide();
                    jQuery_1_4_2("#_creset").unbind("click");
        ...
        function initColor(){
            jQuery_1_4_2("body").append('<div id="colorpanel" style="position: absolute; display: none;"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
            ...
            +colorTable+'</table>';
            jQuery_1_4_2("#colorpanel").html(colorTable);
            jQuery_1_4_2("#_cclose").live('click',function(){
                jQuery_1_4_2("#colorpanel").hide();
                return false;
            }).css({
                "font-size":"12px",
    ...
    jQuery_1_4_2.fn.colorpicker.defaults = {
